...
class User(models.Model):
    ...
    ID = models.PositiveIntegerField(verbose_name='ID пользователя в BX24',
...
class Company(models.Model):
    ...
    inn = models.CharField(verbose_name='ИНН компании', max_length=15, db_index=True, blank=False)
