...
class Command(BaseCommand):
    ...
    #         return
    #     if active:
    #         activities_data = get_activies.get_data_activities(self.bx24, activities_ids)
    ...
    #                 pass
    #                 # res = save_activity.update_activity_drf(activity_data, companies_data.get(activity_id, {}), active)
    #     else:
