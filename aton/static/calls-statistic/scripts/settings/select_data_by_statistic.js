import {templateDepartUl, templateDepartLi, templateDepartEmploye, templateDepartEmployeUser, } from '../templates/settings_select_data_by_statistic.js';
...
export default class SelectDataByStatistic {
    ...
    async getAllDepartments() {
        ...
        // this.departments = DEPART;          // список всех аподраздеоений
    ...
    async renderSelectedDepartment() {
        ...
        for (let department of this.departments) {
            if (this.saveDepartments.includes(department.ID)) {
...
// let container = document.querySelector("#modalSelectDepartAndEmploye");
